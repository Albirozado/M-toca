  ...
  return (
    <li className="relative">
      <Link
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] hover:text-primary border-strokedark bg-slate-600 text-white"
        href="#"
      >
        <span
