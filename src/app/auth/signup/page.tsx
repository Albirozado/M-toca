              ...
              <form>
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg border border-[#6a2f85] bg-[#cf3f84] p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
                ...
                <div className="mt-6 text-center">
                  <p>
                    Ja tem uma conta?{" "}
                    <Link href="/auth/signin" className="text-[#cf3f84]">
                      Sign in
                    </Link>
                  </p>
                </div>
