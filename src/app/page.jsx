          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                 <button className="w-full cursor-pointer rounded-lg border border-[#6a2f85] bg-[#cf3f84] p-4 text-white transition hover:bg-opacity-90" >Login</button>
                </div>
            ...
            <div className="bg-red-500 text-white w-fit text-sm py-1 px-3 rounded-md mt-2 mx-auto">
              <p className="bg-rose-700 lowercase font-medium px-3 py-1">
              {error}
...
/*
   ...
   <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link href="/testando" className="text-[#cf3f84]">
                      Sign Up
                    </Link>
                  </p>
                </div>
